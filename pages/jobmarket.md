...
title: Job Market
layout: page
permalink: jobmarket.html
---

### Job Market

I am on the academic and research-institution job market, expecting to defend my Ph.D. in 2026. My job market papers and full publication record are on the [Publications](publications.html) page. I would be glad to hear from you at [kafari@unmc.edu](mailto:kafari@unmc.edu).

### Application Materials

- [Research Statement — Academic](assets/Afari_Research_Statement_Academic.pdf){:target="_blank" rel="noopener"}
- [Research Statement — Applied / Translational](assets/Afari_Research_Statement_Applied.pdf){:target="_blank" rel="noopener"}
- [Teaching Statement](assets/Afari_Teaching_Statement.pdf){:target="_blank" rel="noopener"}
- [Diversity, Equity, and Inclusion Statement](assets/Afari_DEI_Statement.pdf){:target="_blank" rel="noopener"}
- [Curriculum Vitae](assets/Kyei_Afari_CV.pdf){:target="_blank" rel="noopener"}
